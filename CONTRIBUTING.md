...
AdColony values the open source community and will review all useful changes/additions to the Unity plugin. Please follow the pull request process described below.
